...
macro_rules! define_unsupported_noargs {
    ($($name:ident),* $(,)?) => {$(
        fn $name(&mut self) -> Self::Output {
...
macro_rules! define_unsupported_args {
    ($($name:ident($ty:ty)),* $(,)?) => {$(
        fn $name(&mut self, _arg: $ty) -> Self::Output {
            self.unsupported(stringify!($name));
        }
    )*};
}
...
impl<'a, R: WasmModuleResources> wasmparser::VisitOperator<'a> for FunctionBuilder<R> {
    ...
    define_mem_operands! {
        visit_i32_load(I32Load), visit_i64_load(I64Load), visit_i32_load8_s(I32Load8S), visit_i32_load8_u(I32Load8U), visit_i32_load16_s(I32Load16S), visit_i32_load16_u(I32Load16U), visit_i64_load8_s(I64Load8S), visit_i64_load8_u(I64Load8U), visit_i64_load16_s(I64Load16S), visit_i64_load16_u(I64Load16U), visit_i64_load32_s(I64Load32S), visit_i64_load32_u(I64Load32U), visit_i32_store( I32Store), visit_i64_store(I64Store), visit_i32_store8(I32Store8), visit_i32_store16(I32Store16), visit_i64_store8(I64Store8), visit_i64_store16(I64Store16), visit_i64_store32(I64Store32)
    }

    define_unsupported_args! {
        visit_f32_load(wasmparser::MemArg),
        visit_f64_load(wasmparser::MemArg),
        visit_f32_store(wasmparser::MemArg),
        visit_f64_store(wasmparser::MemArg),
        visit_f32_const(wasmparser::Ieee32),
        visit_f64_const(wasmparser::Ieee64)
    }

    define_unsupported_noargs! {
        visit_f32_eq, visit_f32_ne, visit_f32_lt, visit_f32_gt, visit_f32_le, visit_f32_ge,
        visit_f64_eq, visit_f64_ne, visit_f64_lt, visit_f64_gt, visit_f64_le, visit_f64_ge,
        visit_f32_abs, visit_f32_neg, visit_f32_ceil, visit_f32_floor, visit_f32_trunc, visit_f32_nearest,
        visit_f32_sqrt, visit_f32_add, visit_f32_sub, visit_f32_mul, visit_f32_div, visit_f32_min,
        visit_f32_max, visit_f32_copysign, visit_f64_abs, visit_f64_neg, visit_f64_ceil, visit_f64_floor,
        visit_f64_trunc, visit_f64_nearest, visit_f64_sqrt, visit_f64_add, visit_f64_sub, visit_f64_mul,
        visit_f64_div, visit_f64_min, visit_f64_max, visit_f64_copysign, visit_i32_trunc_f32_s,
        visit_i32_trunc_f32_u, visit_i32_trunc_f64_s, visit_i32_trunc_f64_u, visit_i64_trunc_f32_s,
        visit_i64_trunc_f32_u, visit_i64_trunc_f64_s, visit_i64_trunc_f64_u, visit_f32_convert_i32_s,
        visit_f32_convert_i32_u, visit_f32_convert_i64_s, visit_f32_convert_i64_u, visit_f32_demote_f64,
        visit_f64_convert_i32_s, visit_f64_convert_i32_u, visit_f64_convert_i64_s, visit_f64_convert_i64_u,
        visit_f64_promote_f32, visit_i32_reinterpret_f32, visit_i64_reinterpret_f64, visit_f32_reinterpret_i32,
        visit_f64_reinterpret_i64, visit_i32_trunc_sat_f32_s, visit_i32_trunc_sat_f32_u, visit_i32_trunc_sat_f64_s,
        visit_i32_trunc_sat_f64_u, visit_i64_trunc_sat_f32_s, visit_i64_trunc_sat_f32_u, visit_i64_trunc_sat_f64_s,
        visit_i64_trunc_sat_f64_u
    }

    define_operands! {
        // basic instructions
        visit_br(Br, u32), visit_br_if(BrIf, u32), visit_global_get(GlobalGet, u32), visit_i32_const(I32Const, i32), visit_i64_const(I64Const, i64), visit_call(Call, u32), visit_return_call(ReturnCall, u32), visit_memory_size(MemorySize, u32), visit_memory_grow(MemoryGrow, u32), visit_unreachable(Unreachable), visit_nop(Nop), visit_return(Return), visit_i32_eqz(I32Eqz), visit_i32_eq(I32Eq), visit_i32_ne(I32Ne), visit_i32_lt_s(I32LtS), visit_i32_lt_u(I32LtU), visit_i32_gt_s(I32GtS), visit_i32_gt_u(I32GtU), visit_i32_le_s(I32LeS), visit_i32_le_u(I32LeU), visit_i32_ge_s(I32GeS), visit_i32_ge_u(I32GeU), visit_i64_eqz(I64Eqz), visit_i64_eq(I64Eq), visit_i64_ne(I64Ne), visit_i64_lt_s(I64LtS), visit_i64_lt_u(I64LtU), visit_i64_gt_s(I64GtS), visit_i64_gt_u(I64GtU), visit_i64_le_s(I64LeS), visit_i64_le_u(I64LeU), visit_i64_ge_s(I64GeS), visit_i64_ge_u(I64GeU), visit_i32_clz(I32Clz), visit_i32_ctz(I32Ctz), visit_i32_popcnt(I32Popcnt), visit_i32_add(I32Add), visit_i32_sub(I32Sub), visit_i32_mul(I32Mul), visit_i32_div_s(I32DivS), visit_i32_div_u(I32DivU), visit_i32_rem_s(I32RemS), visit_i32_rem_u(I32RemU), visit_i32_and(I32And), visit_i32_or(I32Or), visit_i32_xor(I32Xor), visit_i32_shl(I32Shl), visit_i32_shr_s(I32ShrS), visit_i32_shr_u(I32ShrU), visit_i32_rotl(I32Rotl), visit_i32_rotr(I32Rotr), visit_i64_clz(I64Clz), visit_i64_ctz(I64Ctz), visit_i64_popcnt(I64Popcnt), visit_i64_add(I64Add), visit_i64_sub(I64Sub), visit_i64_mul(I64Mul), visit_i64_div_s(I64DivS), visit_i64_div_u(I64DivU), visit_i64_rem_s(I64RemS), visit_i64_rem_u(I64RemU), visit_i64_and(I64And), visit_i64_or(I64Or), visit_i64_xor(I64Xor), visit_i64_shl(I64Shl), visit_i64_shr_s(I64ShrS), visit_i64_shr_u(I64ShrU), visit_i64_rotl(I64Rotl), visit_i64_rotr(I64Rotr), visit_i32_wrap_i64(I32WrapI64), visit_i64_extend_i32_s(I64ExtendI32S), visit_i64_extend_i32_u(I64ExtendI32U),
    ...
    fn visit_global_set(&mut self, global_index: u32) -> Self::Output {
        match self.validator.get_operand_type(0) {
            Some(Some(t)) => match t {
                wasmparser::ValType::I32 => self.instructions.push(Instruction::GlobalSet32(global_index)),
                wasmparser::ValType::I64 => self.instructions.push(Instruction::GlobalSet64(global_index)),
                wasmparser::ValType::F32 | wasmparser::ValType::F64 => self.unsupported("floating-point globals"),
                wasmparser::ValType::V128 => self.unsupported("SIMD globals"),
                wasmparser::ValType::Ref(_) => self.instructions.push(Instruction::GlobalSetRef(global_index)),
            },
    ...
    fn visit_drop(&mut self) -> Self::Output {
        match self.validator.get_operand_type(0) {
            Some(Some(t)) => match t {
                wasmparser::ValType::I32 => self.instructions.push(Instruction::Drop32),
                wasmparser::ValType::I64 => self.instructions.push(Instruction::Drop64),
                wasmparser::ValType::F32 | wasmparser::ValType::F64 => self.unsupported("floating-point drop"),
                wasmparser::ValType::V128 => self.unsupported("SIMD drop"),
                wasmparser::ValType::Ref(_) => self.instructions.push(Instruction::DropRef),
            },
            _ => self.visit_unreachable(),
        }
    }
    ...
    fn visit_local_get(&mut self, idx: u32) -> Self::Output {
        ...
        match self.validator.get_local_type(idx) {
            Some(t) => match t {
                wasmparser::ValType::I32 => self.instructions.push(Instruction::LocalGet32(resolved_idx)),
                wasmparser::ValType::I64 => self.instructions.push(Instruction::LocalGet64(resolved_idx)),
                wasmparser::ValType::F32 | wasmparser::ValType::F64 => self.unsupported("floating-point locals"),
                wasmparser::ValType::V128 => self.unsupported("SIMD locals"),
                wasmparser::ValType::Ref(_) => self.instructions.push(Instruction::LocalGetRef(resolved_idx)),
            },
            _ => self.visit_unreachable(),
        }
    }
    ...
    fn visit_local_set(&mut self, idx: u32) -> Self::Output {
        ...
        ) = self.instructions.last()
        {
            ...
            match self.validator.get_operand_type(0) {
                Some(Some(t)) => match t {
                    wasmparser::ValType::I32 => self.instructions.push(Instruction::LocalCopy32(from, resolved_idx)),
                    wasmparser::ValType::I64 => self.instructions.push(Instruction::LocalCopy64(from, resolved_idx)),
                    wasmparser::ValType::F32 | wasmparser::ValType::F64 => self.unsupported("floating-point locals"),
                    wasmparser::ValType::V128 => self.unsupported("SIMD locals"),
                    wasmparser::ValType::Ref(_) => self.instructions.push(Instruction::LocalCopyRef(from, resolved_idx)),
                },
                _ => self.visit_unreachable(),
            }
            return;
        ...
        match self.validator.get_operand_type(0) {
            Some(Some(t)) => match t {
                wasmparser::ValType::I32 => self.instructions.push(Instruction::LocalSet32(resolved_idx)),
                wasmparser::ValType::I64 => self.instructions.push(Instruction::LocalSet64(resolved_idx)),
                wasmparser::ValType::F32 | wasmparser::ValType::F64 => self.unsupported("floating-point locals"),
                wasmparser::ValType::V128 => self.unsupported("SIMD locals"),
                wasmparser::ValType::Ref(_) => self.instructions.push(Instruction::LocalSetRef(resolved_idx)),
            },
            _ => self.visit_unreachable(),
        }
    }
    ...
    fn visit_local_tee(&mut self, idx: u32) -> Self::Output {
        ...
        match self.validator.get_operand_type(0) {
            Some(Some(t)) => match t {
                wasmparser::ValType::I32 => self.instructions.push(Instruction::LocalTee32(resolved_idx)),
                wasmparser::ValType::I64 => self.instructions.push(Instruction::LocalTee64(resolved_idx)),
                wasmparser::ValType::F32 | wasmparser::ValType::F64 => self.unsupported("floating-point locals"),
                wasmparser::ValType::V128 => self.unsupported("SIMD locals"),
                wasmparser::ValType::Ref(_) => self.instructions.push(Instruction::LocalTeeRef(resolved_idx)),
            },
            _ => self.visit_unreachable(),
        }
    }
    ...
    fn visit_typed_select(&mut self, ty: wasmparser::ValType) -> Self::Output {
        match ty {
            wasmparser::ValType::I32 => self.instructions.push(Instruction::Select32),
            wasmparser::ValType::I64 => self.instructions.push(Instruction::Select64),
            wasmparser::ValType::F32 | wasmparser::ValType::F64 => self.unsupported("floating-point select"),
            wasmparser::ValType::V128 => self.unsupported("SIMD select"),
            wasmparser::ValType::Ref(_) => self.instructions.push(Instruction::SelectRef),
        };
    }
}

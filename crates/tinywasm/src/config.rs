...
/// Default initial size for the 32-bit value stack (i32 values).
pub const DEFAULT_VALUE_STACK_32_INIT_SIZE: usize = 32 * 1024; // 32KB

/// Default initial size for the 64-bit value stack (i64 values).
...
pub struct StackConfig {
    /// Initial size for the 32-bit value stack (i32 values).
    pub value_stack_32_init_size: Option<usize>,
    /// Initial size for the 64-bit value stack (i64 values).
